...
namespace XKey{
    ...
    enum Key {
        ...
        Key_Delete = 0x07,
        Key_Pause = 0x08,
        Key_Print = 0x09,               // print screen
        Key_SysReq = 0x0a,
        Key_Clear = 0x0b,
        Key_Home = 0x0c,                // cursor movement
        Key_End = 0x0d,
        Key_Left = 0x0e,
        Key_Up = 0x0f,
        Key_Right = 0x10,
        ...
        Key_F23 = 0x31,
        Key_F24 = 0x32,
        Key_F25 = 0x33,                // F25 .. F35 only on X11
        Key_F26 = 0x34,
        Key_F27 = 0x35,
        Key_F28 = 0x36,
        Key_F29 = 0x37,
        ...
        Key_F34 = 0x3c,
        Key_F35 = 0x3d,
        Key_Super_L = 0x3e,                 // extra keys
        Key_Super_R = 0x3f,
        Key_Menu = 0x40,
        Key_Hyper_L = 0x41,
        Key_Hyper_R = 0x42,
        Key_Help = 0x43,
        Key_Direction_L = 0x44,
        Key_Direction_R = 0x45,
        Key_Space = 0x46,                // 7 bit printable ASCII
        Key_Any = Key_Space,
        Key_Exclam = 0x47,
        Key_QuoteDbl = 0x48,
        Key_NumberSign = 0x49,
